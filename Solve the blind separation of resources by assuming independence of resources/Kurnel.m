...
%%
subplot(3,1,1)
plot(S(1,:),'black','LineWidth',1.5)
hold on 
plot(without_noise(1,:),'LineWidth',1.75)
plot(X(1,:),'blue')
legend('source','observations without noise','observations with noise')

subplot(3,1,2)
plot(S(2,:),'black','LineWidth',1.5)
hold on 
plot(without_noise(2,:),'LineWidth',1.75)
plot(X(2,:),'blue')  

subplot(3,1,3)
plot(S(3,:),'black','LineWidth',1.5)
hold on 
plot(without_noise(3,:),'LineWidth',1.75)
plot(X(3,:),'blue')
%%
warning('off', 'all')
B =[0.321,0.532,0.533; 
